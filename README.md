...
Я строю интегрированный со смежными системами control-plane на основе k8s apiserver и controller-runtime для управления множеством агентов, которые при помощи eBPF фильтруют трафик на хостах.
